...
cp "${ROOT_DIR}/ci/release/templates/winlator-v0.9q.ru-en.md" "${OUT_DIR}/winlator-v0.9q.md"
...
printf '[release-notes] Wrote %s and %s\n' "${OUT_DIR}/winlator-v0.9q.md" "${OUT_DIR}/wcp-stable.md"
