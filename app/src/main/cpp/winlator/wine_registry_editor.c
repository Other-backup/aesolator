...
Java_com_winlator_cmod_core_WineRegistryEditor_getKeyLocation(JNIEnv *env, jobject obj,
...
JNIEXPORT jintArray JNICALL
Java_com_winlator_cmod_core_WineRegistryEditor_getValueLocation(JNIEnv *env, jobject obj,
