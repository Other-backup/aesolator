...
public abstract class Box86_64PresetManager {
    private static final String TAG = "Box86_64PresetManager";
    ...
    public static ArrayList<Box86_64Preset> getPresets(String prefix, Context context) {
        ...
        presets.add(new Box86_64Preset(Box86_64Preset.UNITY, "Unity"));
        presets.add(new Box86_64Preset(Box86_64Preset.UNITY_MONO_BLEEDING_EDGE, "Unity Mono Bleeding Edge"));
        presets.add(new Box86_64Preset(Box86_64Preset.DENUVO, "Denuvo"));
        for (String[] preset : customPresetsIterator(prefix, context)) {
    ...
    public static void loadSpinner(String prefix, Spinner spinner, String selectedId) {
        ...
        try {
            ...
            Log.w(TAG, "Failed to load Box86_64 preset spinner", e);
        }
    }
    ...
    public static String getSpinnerSelectedId(Spinner spinner) {
        ...
        return Box86_64Preset.COMPATIBILITY;
    }
}
