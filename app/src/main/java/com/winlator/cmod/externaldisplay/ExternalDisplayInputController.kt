...
class ExternalDisplayInputController(
    ...
    companion object {
        @JvmStatic
        fun fromConfig(value: String?): Mode =
    ...
    private fun renderContent() {
        when (mode) {
            ExternalDisplayInputController.Mode.TOUCHPAD -> {
                val pad =
                    TouchpadView(context, xServer, null, null).apply {
                        layoutParams =
            ...
            ExternalDisplayInputController.Mode.KEYBOARD -> {
                ...
                val hintIcon =
                    ImageView(context).apply {
                        ...
                        setImageResource(R.drawable.ae_icon_keyboard)
                        alpha = 0.35f
            ...
            else -> setContentView(FrameLayout(context))
        }
    }
}
...
private class HybridInputLayout(
    ...
    private val keyboardToggleButton =
        ImageButton(context).apply {
            val density = resources.displayMetrics.density
            val sizePx = (56 * density).toInt()
            val marginPx = (16 * density).toInt()
            layoutParams =
                LayoutParams(sizePx, sizePx).apply {
    ...
    private fun updateToggleButtonPosition() {
        keyboardToggleButton.translationY =
