...
public class XIRawMotionNotify extends Event {
    ...
    private static final short XI_RAW_MOTION_EVTYPE = 17;
    ...
    public void send(short sequenceNumber, XOutputStream outputStream) throws IOException {
        try (XStreamLock lock = outputStream.lock()) {
            ...
            outputStream.writeShort(XI_RAW_MOTION_EVTYPE);
            ...
            for (double valuator : valuators) outputStream.writeFP3232(valuator);
            for (double valuator : valuators) outputStream.writeFP3232(valuator);
        }
    }
}
