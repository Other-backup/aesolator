...
public enum RCField {
    ...
    public static String[] getEnabledField() {
        ...
        for (RCField field : values()) {
            if (field.enabled) list.add(field.toString());
        }
    ...
    private static class S {
        ...
        private static final String[] S2 = {"0", "1"};
        private static final String[] S3 = {"0", "1", "2"};
        private static final String[] S4 = {"0", "1", "2", "3"};
    }
}
