    ...
    private static class FSR1EasuMaterial extends ScreenMaterial {
        ...
        protected String getFragmentShader() {
            return
                ...
                "    con0 = vec4(inputViewportInPixels.x / outputSizeInPixels.x, inputViewportInPixels.y / outputSizeInPixels.y, 0.5 * inputViewportInPixels.x / outputSizeInPixels.x - 0.5, 0.5 * inputViewportInPixels.y / outputSizeInPixels.y - 0.5);\n" +
