    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action != null && action.equals("com.winlator.SHORTCUT_ADDED")) {
            ...
            if (isShortcutAdded) {
                ...
                Toast.makeText(context, R.string.shortcut_pin_request_forwarded, Toast.LENGTH_SHORT).show();
            } else {
        ...
        if (shortcutName != null && shortcutIcon != null && shortcutIntent != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                try {
                    ...
                    Toast.makeText(context, R.string.shortcut_pin_broadcast_success, Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Log.e(LOG_TAG, "Error sending broadcast for installing shortcut: " + e.getMessage(), e);
                    Toast.makeText(context, R.string.shortcut_pin_broadcast_failed, Toast.LENGTH_SHORT).show();
                }
            }
        } else {
