...
public class DXVKHelper {
    ...
    public static void setEnvVars(android.content.Context context, KeyValueSet config, EnvVars envVars) {
    ...
    public static void setVKD3DEnvVars(android.content.Context context, KeyValueSet config, EnvVars envVars) {
