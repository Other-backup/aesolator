...
#define ENABLE_VALIDATION_LAYER 0 // Android production build ships without validation layers.
#define DEBUG_MODE 0 // Production build keeps debug output disabled.
#define MEMORY_POOL_MAX_SIZE 65536
#define SERVER_RING_BUFFER_SIZE 4194304
#define CLIENT_RING_BUFFER_SIZE 262144
#define VORTEK_SERVER_PATH "/data/data/com.winlator.cmod/files/imagefs/tmp/.vortek/V0"
