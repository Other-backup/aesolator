...
public class ProcessInfo {
    ...
    public ProcessInfo(int pid, String name, long memoryUsage, int affinityMask, boolean wow64Process) {
        this(pid, name, "", memoryUsage, affinityMask, wow64Process);
    }

    public ProcessInfo(int pid, String name, String path, long memoryUsage, int affinityMask, boolean wow64Process) {
        this.pid = pid;
        this.name = name;
