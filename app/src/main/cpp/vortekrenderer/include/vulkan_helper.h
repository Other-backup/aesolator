...
extern uint32_t getEffectiveVkApiVersion(VkContext* context);
...
extern void injectRequiredDeviceExtensions(VkContext* context, VkPhysicalDevice physicalDevice, char*** extensions, uint32_t* extensionCount);
